...
//         driver.quit();
    ...
    public void PromptAlert() throws InterruptedException {
        ...
        Assertions.assertEquals("Podaj nazwê miasta w któym mieszkasz", promptAlert.getText());
        promptAlert.accept();
    }
    ...
    public void ConfirmAlert() throws InterruptedException {
        ...
        Assertions.assertEquals("Czy chcesz zatwierdziæ operacjê usuniêcia Twoich danych osobowych?", confirmAlert.getText());
        confirmAlert.accept();
        confirmButton.click();
        Assertions.assertEquals("Czy chcesz zatwierdziæ operacjê usuniêcia Twoich danych osobowych?", confirmAlert.getText());
    ...
    public void DoubleClickAlert() {
        Actions action = new Actions(driver);
        action.doubleClick(driver.findElement(By.cssSelector("input[value='Dwuklik poka¿ komunikat']"))).perform();
    ...
    public void OpenNewWindow() {
        ...
        Assertions.assertEquals("Warto wykonywaæ testy automatyczne – Selenium Shop Automatyzacja Testów", driver.getTitle());
        driver.findElement(By.id("imie_nazwisko")).sendKeys("Andrzej S");
        driver.findElement(By.cssSelector("input[value='Zamknij okno przegl¹darki']")).click();
